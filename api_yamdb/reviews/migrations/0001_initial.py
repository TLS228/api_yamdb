# Generated by Django 3.2.16 on 2024-10-04 08:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Пользователь с таким именем уже существует.'}, max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(), django.core.validators.RegexValidator(message='Имя пользователя не может быть "me"', regex='^((?!me).)*$')], verbose_name='Имя пользователя')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Почта')),
                ('bio', models.CharField(blank=True, max_length=256, verbose_name='Биография')),
                ('role', models.CharField(choices=[('user', 'обычный'), ('moderator', 'модератор'), ('admin', 'администратор')], default='user', max_length=256, verbose_name='Роль')),
