# Generated by Django 3.2 on 2024-10-01 13:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'обычный'), ('moderator', 'модератор'), ('admin', 'администратор')], default='user', max_length=16, verbose_name='Роль')),
                ('confirmation_code', models.PositiveSmallIntegerField(blank=True, verbose_name='Код подтверждения')),
